...
class App extends Component {
  ...
  onIOSClickHandle = () => {
    window.location.href = 'itms-services:///?action=download-manifest&url=https://net.huanmusic.com/eos/production/05191255/cceos.plist';
  }
  ...
  onAndroidClickHandle = () => {
    ...
    if (weixinToken === true && androidToken && true) {
      ...
      window.location.href = 'https://net.huanmusic.com/eos/production/05191255/cceos-release.apk';
    }
  }
