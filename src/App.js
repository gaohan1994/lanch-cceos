...
class App extends Component {
  ...
  onIOSClickHandle = () => {
    ...
    if (weixinToken === true) {
      ...
      window.location.href = 'itms-services:///?action=download-manifest&url=https://net.huanmusic.com/eos/app/09261202/cceos.plist';
    }
  }
  ...
  onAndroidClickHandle = () => {
    ...
    if (weixinToken === true && androidToken && true) {
      ...
      window.location.href = 'https://net.huanmusic.com/eos/app/09261202/app-release.apk';
    }
  }
